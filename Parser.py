...
def main(args):
    ...
    for r in stats[1:]:
        recorder.join(r)
    pprint(json.dumps(recorder.stats()))

if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="A parser for strace logs")
    parser.add_argument('-f', '--strace-files', nargs='+', dest='files', help='The log file to parse', required=True)
